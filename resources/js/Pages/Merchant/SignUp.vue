    ...
    <Stepper :steps="steps" @finish="finish">
        <template v-slot="{ currentStep }">
            ...
            <div v-if="currentStep === 2">
                ...
                <div class="w-full max-w-lg mx-auto space-y-4">
                    <div v-for="field in locationFields" :key="field.name" class="flex items-center justify-between">
                        <label class="text-gray-700 dark:text-white text-sm font-medium w-1/4">
                            {{ field.label }} <span class="text-red-400" v-if="field.required">*</span>
                        </label>
                        <input v-model="merchantData[field.name]" :type="field.type"
            ...
            <div v-if="currentStep === 3">
                ...
                <div class="w-full max-w-lg mx-auto space-y-4">
                    <div v-for="field in businessFields" :key="field.name" class="flex items-center justify-between">
                        <label class="text-gray-700 dark:text-white text-sm font-medium w-1/4">
                            {{ field.label }} <span class="text-red-400" v-if="field.required">*</span>
                        </label>

                        <!-- Select for Category -->
                        <select v-if="field.name === 'business_category'" v-model="merchantData.business_category"
                        ...
                        <template v-else-if="field.name === 'business_sub_category'">
                            <select v-if="merchantData.business_category && merchantData.business_category !== 'Others'"
            ...
            <div v-if="currentStep === 4">
                ...
                <div class="max-w-md mx-auto p-6 bg-white">
                    ...
                    <div class="flex space-x-3">
                        <button v-for="discount in discounts" :key="discount" @click="selectDiscount(discount)" :class="['px-4 py-2 border rounded-md text-blue-600 border-blue-400 transition',
